 ...
 * <p>{@code @Bean}
 * <p>{@code public RedisMessageListener redisMessageListener(RedisMessageListenerContainer redisMessageListenerContainer)} {
 * <p>{@code RedisMessageListener redisMessageListener = new RedisMessageListener();}
 * <p>{@code // 自定义事件监听通道}
 * <p>{@code redisMessageListenerContainer.addMessageListener(redisMessageListener, new ChannelTopic(ListenerChannel.CACHE_CHANNEL));}
 * <p>{@code return redisMessageListener;}
 * <p>{@code }}
